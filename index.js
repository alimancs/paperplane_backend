...
import disconnectDB from './db/disconnect.js';
...
app.use(cors( { credentials:true, origin:['https://paperplane-blog.onrender.com', 'http://localhost:5173']}));
...
// disconnect from DB gracefully on process exit
